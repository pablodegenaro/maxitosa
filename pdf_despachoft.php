...
$consul_des_det = mssql_query("SELECT numeros, tipofac from appfacturas_detft where correl = '$correl'");
...
$genera = mssql_query("
	...
	TipoFac in ('F') AND (numerod in ($condiciones)) order by saprod.marca
	");
