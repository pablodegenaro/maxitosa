...
<div class="content-wrapper">
    <section class="content mt-2">
        <div class="card card-saint-soft">
            <div class="card-header">
                <form id="clie_form" method="post">
                    ...
                    <input type="hidden" name="mdesc" id="mdesc_input" value="0"/>
                    <div class="row">
                        <!-- INPUTS DE SELECCION -->
                        <div class="col-4">
                            <div class="row"> 
                                <div class="col-12">
                                    <h3 class="m-1" style="color: #fcb813;"><strong>Devolución Factura</strong></h3>
                                </div>
                                <div class="col-12 mt-1">
                                    <div class="form-group">
                                        <select id="clie" name="clie" class="form-control select2" style="width: 100%;">
                                            ...
                                            <?php
                                            $saclie = mssql_query("SELECT CodClie, Descrip FROM SACLIE ORDER BY CodClie ASC");
                                    ...
                                    <div class="col-4 pr-3">
                                        <dl class="row">
                                            <dt class="col-sm-8 text-right">Dev. Factura Nro. </dt> 
        ...
        <div class="modal fade" id="totalModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="overflow-y: scroll;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #084f8a;color: white;">
                        <h4 class="modal-title"><strong>(DEV. FACTURA)</strong> TOTAL OPERACIÓN</h4>
            ...
            <form id="total_modal_form" method="post">
                <div class="modal-body">
                    <div id="div_nc" class="row form-group">
                        <label class="col-sm-4 col-form-label">Emitir nota crédito</label>
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-1">
                                    <div class="form-check pt-2">
                                        <input class="form-check-input" type="checkbox" id="emi_nc" name="emi_nc" value="1" checked>
                                    </div>
                                </div> 
                                <div class="col-10 pt-1">
                                    <input type="hidden" name="carga_nc" id="carga_nc" value="0"/>
                                    <button id="nc_btn" type="button" class="btn btn-outline-primary btn-sm ">detalles n/c</button>
                                </div>
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="date" class="form-control" id="fechaemi" name="fechaemi" value="<?= date('Y-m-d'); ?>" readonly="" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-1">
                                <input id="diasven" name="diasven" type="text" class="form-control" value="0" min="0" onkeyup="setFechaV('num')" onkeypress="return isNumberKey(this, event)" readonly="" required="">
                            </div>
                            <div class="col-sm-7">
                                <div class="input-group">
                                    <input type="date" class="form-control" id="fechaven" name="fechaven" onchange="setFechaV('date')" min="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>" readonly="" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
                            <label for="comentario_delvol" class="col-sm-4 col-form-label">Motivo Devolución</label>
                            <div class="col-sm-8">
                                <select id="comentario_delvol" name="comentario_delvol" class="form-control custom-select" style="width: 100%;" required>
                                    <option value="">-- Seleccione motivo devolución --</option>
                                    <option value="CLIENTE CERRADO">CLIENTE CERRADO</option>
                                    <option value="ERROR EN FACTURACION">ERROR EN FACTURACION</option>
                                    <option value="ERROR EN TOMA DE PEDIDO">ERROR EN TOMA DE PEDIDO</option>
                                    <option value="ERROR EN SISTEMA">ERROR EN SISTEMA</option>
                                    <option value="CLIENTE SIN DINERO">CLIENTE SIN DINERO</option>
                                    <option value="FUERA DE FECHA ACORDADA">FUERA DE FECHA ACORDADA</option>
                                    <option value="PRODUCTO MAL ESTADO">PRODUCTO MAL ESTADO</option>
                                    <option value="PRODUCTO  VENCIDO">PRODUCTO  VENCIDO</option>
                                    <option value="DIFERENCIA EN PRECIO">DIFERENCIA EN PRECIO</option>
                                    <option value="MERCANCIA A CONSIGNACION">MERCANCIA A CONSIGNACION</option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="pagosdevolModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #084f8a;color: white;">
                    <h4 class="modal-title">Emisión de notas de crédito</h4>
                    <button type="button" onclick="cerrarModalCXC()" class="btn btn-sm bg-light float-right">Cerrar</button>
                <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button> -->
            </div>
            
            <form id="nc_form" method="post">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            <table id="cxc_data" class="table table-sm table-bordered table-striped text-center">
                                <thead style="background-color: #00137f;color: white;">
                                    <tr>
                                        <th class="small align-middle">Tipo</th>
                                        <th class="small align-middle">Número</th>
                                        <th class="small align-middle">Detalle</th>
                                        <th class="small align-middle">Vende.</th>
                                        <th class="small align-middle">Emisión</th>
                                        <th class="small align-middle">Vence</th>
                                        <th class="small align-middle">Saldo</th>
                                        <th class="small align-middle">Cancelado</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- TD de la tabla que se pasa por ajax -->
                        ...
                        <div class="col-12">
                            <table class="table table-sm table-bordered table-striped text-center">
                                <tbody>
                                    <tr>
                                        <td style="width: 20%" class="small align-middle text-right">Nota crédito nro.</td>
                                        <td style="width: 14%" class="small align-middle"><input type="text" class="form-control text-left" id="nc_nro" disabled></td>
                                        <td style="width: 30%" class="small align-middle text-right">Monto nota crédito</td>
                                        <td style="width: 17%" class="small align-middle"><input type="text" class="form-control text-right" id="monto_nc" value="0.00" disabled></td>
                                        <td style="width: 19%" class="small align-middle"><input type="text" class="form-control text-right" id="pagototal" value="0.00" disabled></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-6" id="div_alm_anticipo">
                            <table class="table table-sm table-bordered table-striped text-center">
                                <tbody>
                                    <tr>
                                        <td style="width: 10%" class="small align-middle">
                                            <input type="checkbox" id="alm_anti" name="alm_anti" value="1">
                                        </td>
                                        <td style="width: 45%" class="small align-middle text-right">Almacenar como anticipo</td>
                                        <td style="width: 45%" class="small align-middle"><input type="text" class="form-control text-right" id="monto_anticipo" name="monto_anticipo" value="0" onkeyup="evaluarAnticipoNe()" onkeydown="return enterKeyPressedAnticipoCxc(this,event)" onkeypress="return isNumberKey(this, event)" disabled=""></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="modal-footer">
                    <button id="btn_accept_nc" type="buttom" class="btn btn-saint pull-left">
                        Aceptar
                    </button>
                </div>
            </form>
...
<script type="text/javascript" src="ventas_devolfac.js"></script>
<script type="text/javascript" src="ventas_devolfac_gestion_tabla.js"></script>
<script type="text/javascript" src="ventas_devolfac_gestion_tabla_cxc.js"></script>