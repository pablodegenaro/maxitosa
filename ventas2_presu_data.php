                    ...
                    if ($correl_nuevo != "") {
                        ...
                        foreach ($arr_prod as $i => $codprod) {
                            if (!empty($codprod)) {
                                ...
                                $proc_fact = mssql_query("EXEC [App_Ped_Presu_Items] @NumeroD ='$correl_nuevo', @TipoFac ='$tipofac_facturar', @CodSucu ='$codsucu', @NroOrg ='', @TipoOrg ='', @Deposito = '$codubic', @Vendedor='$codvend', @NroLinea ='$nroLinea', @CodItem ='$codItem', @Cantidad ='$cantidad', @EsUnida ='$esunid', @TipoPvp = '$tipopvp', @Factor ='$tasa', @FechaEmi ='$fechaemi', @DiasVen ='0' ")
