        ...
        <div class="col-md-12">
            <div class="card card-saint">
                <script type="text/javascript">
                    function guarda(){
                        if (  document.getElementById("depo").value != "" ){
                ...
                <form class="form-horizontal" action="principal1.php?page=inventario_valorizado_ver&mod=1" method="post" id="" name="">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Seleccion</label>
                            <div class="form-group row">
                                <div class="col-md-8">
                                    <select class="select2" name="depo[]" id="depo[]" multiple="multiple" data-placeholder="Seleccione Almacen" data-dropdown-css-class="select2-blue" style="width: 100%;" required>
                                        <?php
