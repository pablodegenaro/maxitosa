...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <?php 
                $arr_modulos_ventas = array('ventas2_fac.php','ventas2_devolfac.php');
                        ...
                        <div class="small-box bg-info pb-4">
                            <div class="inner">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <?php
                                        if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_fac.php')) > 0) {
                                            ?>
                                            <a class="text-light" href="principal3.php?page=ventas2_fac&mod=1">Emisión Facturas</a>
                                            <br>
                                            <?php 
                                        }
                                        ?>
                                    ...
                                    <div class="col-12">
                                        <?php
                                        if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_devolfac.php')) > 0) {
                                            ?>
                                            <a class="text-light" href="principal3.php?page=ventas2_devolfac&mod=1">Devolución Facturas</a>
                                            <?php 
                                        }
                                        ?>
                                    </div>
                                ...
                                <?php 
                                $arr_modulos_ventas_imp = array('ventas2_fac_pdf.php','ventas2_devolfac_pdf.php');
                                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas_imp)) > 0) {
                                    ?>
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            <?php
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_fac_pdf.php')) > 0) {
                                                ?>
                                        ...
                                        <div class="col-12">
                                            <?php 
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_devolfac_pdf.php')) > 0) {
                                                ?>
                ...
                <?php 
                $arr_modulos_ventas = array('ventas2_ne.php','ventas2_devolne.php');
                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas)) > 0) {
                    ?>
                    <!-- ./col -->
                    <div class="col-lg-6 col-6">
                        <div class="small-box bg-success pb-4">
                            <div class="inner">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <?php 
                                        if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_ne.php')) > 0) {
                                            ?>
                                            <a href="principal3.php?page=ventas2_ne&mod=1" class="text-light">Emisión NE</a>
                                            <br>
                                            <?php 
                                        } 
                                        ?>
                                    ...
                                    <div class="col-12">
                                        <?php
                                        if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_devolne.php')) > 0) {
                                            ?>
                                            <a href="principal3.php?page=ventas2_devolne&mod=1" class="text-light">Devolución NE</a>
                                            <br>
                                            <?php 
                                        } ?>
                                    </div>
                                ...
                                <?php 
                                $arr_modulos_ventas_imp = array('ventas2_ne_pdf.php','ventas2_devolne_pdf.php');
                                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas_imp)) > 0) {
                                    ?>
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            <?php
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_ne_pdf.php')) > 0) {
                                                ?>
                                        ...
                                        <div class="col-12">
                                            <?php 
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_devolne_pdf.php')) > 0) {
                                                ?>
                ...
                <?php 
                $arr_modulos_ventas = array('ventas2_ped.php','ventas2_ped_pdf.php','ventas2_ped_eliminar.php');
                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas)) > 0) {
                    ?>
                    <!-- ./col -->
                    <div class="col-lg-6 col-6">
                        <div class="small-box bg-danger pb-4">
                            <div class="inner">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <?php 
                                        if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_ped.php')) > 0) {
                                            ?>
                                            <a href="principal3.php?page=ventas2_ped&mod=1" class="text-light">Emisión Pedido</a>
                                            <?php 
                                        }
                                        ?>
                                    </div>
                                ...
                                <?php 
                                $arr_modulos_ventas_imp = array('ventas2_ped_pdf.php','ventas2_ped_eliminar.php');
                                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas_imp)) > 0) {
                                    ?>
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            <?php
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_ped_pdf.php')) > 0) {
                                                ?>
                                        ...
                                        <div class="col-12">
                                            <?php 
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_ped_eliminar.php')) > 0) {
                                                ?>
                ...
                <?php 
                $arr_modulos_ventas = array('ventas2_presu.php','ventas2_presu_pdf.php','ventas2_presu_eliminar.php');
                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas)) > 0) {
                    ?>
                    <!-- ./col -->
                    <div class="col-lg-6 col-6">
                        <div class="small-box bg-gray pb-4">
                            <div class="inner">
                                ...
                                <div class="row">
                                    <dis class="col-12">
                                        <?php 
                                        if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_presu.php')) > 0) {
                                            ?>
                                            <a href="principal3.php?page=ventas2_presu&mod=1" class="text-light">Emisión Presupuesto</a>
                                            <?php 
                                        }
                                        ?>
                                    </dis>
                                ...
                                <?php 
                                $arr_modulos_ventas_imp = array('ventas2_presu_pdf.php','ventas2_presu_eliminar.php');
                                if (count(Permisos::verficarArrayPermisoPorSessionUsuario($arr_modulos_ventas_imp)) > 0) {
                                    ?>
                                    <div class="row mt-4">
                                        <div class="col-12">
                                            <?php
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_presu_pdf.php')) > 0) {
                                                ?>
                                        ...
                                        <div class="col-12">
                                            <?php 
                                            if (count(Permisos::verficarPermisoPorSessionUsuario('ventas2_presu_eliminar.php')) > 0) {
                                                ?>
...
<script type="text/javascript" src="ventas2_index.js"></script>