	...
	<section class="content">
		...
		<div class="col-md-12">
			<div class="card card-saint">
				...
				<form class="form-horizontal" action="principal.php?page=reporte_compras_ver&mod=1" method="post" id="" name="">
					<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-sm-12">
									<div class="form-check form-check-inline">
										<label for="vutil" class="col-form-label col-sm-4"></label><br>
