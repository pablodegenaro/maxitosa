...
$del = mssql_query("DELETE FROM appfacturas_det WHERE numeros = '$numerod' and tipofac ='$tipofac'");
...
// Sender &amp; Recipient
	...
	$mail->Subject = "Eliminado el Documento $tipo_d # $numerod - del Despacho # $correl";
	$body="El usuario $usuario elimino el Documento $tipo_d # $numerod , correspondiente al despacho $correl .";
	$mail->Body=$body;
	$mail->Send();
