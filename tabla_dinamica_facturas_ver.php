...
if ($_SESSION['login']) {
    ...
    # =============================================================
		...
		$consulta = mssql_query("
			...
			where 
			DATEADD(dd, 0, DATEDIFF(dd, 0, SAITEMFAC.FechaE)) between '$fechai' and '$fechaf'  and SAITEMFAC.CodSucu='$sucursal' and  SAITEMFAC.codvend like '$edv' and (SAITEMFAC.tipofac = 'A' or SAITEMFAC.Tipofac = 'B')  order by SAITEMFAC.fechae");
    ...
    # ====================================================================
		...
		$consulta = mssql_query("
			...
			left join SAPROD_99 as d on SAITEMFAC.CodItem=d.CodProd
			where 
			DATEADD(dd, 0, DATEDIFF(dd, 0, SAITEMFAC.FechaE)) between '$fechai' and '$fechaf'   and SAITEMFAC.CodSucu='$sucursal' and  (SAITEMFAC.tipofac = 'A' or SAITEMFAC.Tipofac = 'B')  order by SAITEMFAC.fechae");
 ...
 # =============================================================================
    ...
    # =============================================================================
		...
		$consulta = mssql_query("
			...
			left join SAPROD_99 as d on SAITEMFAC.CodItem=d.CodProd
			where 
			DATEADD(dd, 0, DATEDIFF(dd, 0, SAITEMFAC.FechaE)) between '$fechai' and '$fechaf'  and   (SAITEMFAC.tipofac = 'A' or SAITEMFAC.Tipofac = 'B')  order by SAITEMFAC.fechae");
    ...
    # =============================================================================
		...
		$consulta = mssql_query("
			...
			left join SAPROD_99 as d on SAITEMFAC.CodItem=d.CodProd
			where 
			DATEADD(dd, 0, DATEDIFF(dd, 0, SAITEMFAC.FechaE)) between '$fechai' and '$fechaf'  and  SAITEMFAC.codvend like '$edv' and (SAITEMFAC.tipofac = 'A' or SAITEMFAC.Tipofac = 'B')  order by SAITEMFAC.fechae");
	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">Tabla Dinamica de Facturas</h1>
					</div>
				</div>
				<div class="row mb-2">
					...
					<div class="col-sm-3 mt-4 form-check-inline">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<script type="text/javascript">
							function regresa(){
								window.location.href = "principal1.php?page=tabla_dinamica_facturas&mod=1";
							}
						</script>
					...
					<tbody style="background-color: aliceblue">
						...
						for ($i = 0; $i < mssql_num_rows($consulta); $i++) {?>
							<tr >
								...
								<td><?php if (mssql_result($consulta, $i, "tipo") == 'A') {
						...
						<tr>
							<td colspan="20" align="center">
								<div align="center">
									<div align="center"><a href="tabladinamica_excel.php?&fechai=<?php echo $_POST['fechai']; ?>&fechaf=<?php echo $_POST['fechaf']; ?>&edv=<?php echo $edv; ?>&sucursal=<?php echo $sucursal; ?>"><img src="images/excel.jpeg" width="19" height="18" border="0" /> Exportar a Excel</a>&nbsp;&nbsp;</div>
								</div>
							</td>
						</tr>
					</tbody>
