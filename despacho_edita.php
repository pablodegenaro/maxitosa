...
$chofer = "";
if ($aux != ""){
  $consulta_correl = mssql_query("SELECT * from appfacturas where correl = '$aux'");
    ...
    <div class="card card-info">
      <div class="card-header">
        <script type="text/javascript">
          ...
          function regresa(){
            window.location.href = "principal1.php?page=despacho_visual&mod=1&correl2=<?php echo $correl; ?>&usuario=<?php echo $usuario; ?>";
          }
        </script>
        <h3 class="card-title">Editar Despacho # <?php echo $aux; ?></h3>
      </div>
      <form class="form-horizontal" action="principal1.php?page=despacho_edita_ver&mod=1&correl=<?php echo $aux; ?>" method="post" id="edit_despacho" name="edit_despacho">
        <div class="card-body">
