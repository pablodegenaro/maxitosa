			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Tabla Dinamica Notas de Entrega</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="card card-saint">
					...
					<div class="card-header">
						<h3 class="card-title">Tabla Dinamica de Notas de Entregas</h3>
					</div>
					<div class="card-body">
						<form class="form-horizontal" action="principal.php?page=tabla_dinamica_ne_ver&mod=1" method="post" id="" name="">
											...
											<select class="form-control custom-select" name="edv" id="edv" style="width: 100%;" required>
												...
												if (mssql_num_rows($vendedores) != 0){ 
													for($i=0;$i<mssql_num_rows($vendedores);$i++){
														?>                         
														<option value="<?php echo mssql_result($vendedores,$i,"codvend"); ?>"><?php echo mssql_result($vendedores,$i,"codvend"); ?>: <?php echo substr(mssql_result($vendedores,$i,"descrip"), 0, 35); ?></option>
														<?php 
													}
												} ?>
											</select>
