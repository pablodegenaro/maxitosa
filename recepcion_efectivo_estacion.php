...
<body class="hold-transition lockscreen">
    <div class="lockscreen-wrapper">
        ...
        <form action="recepcion_efectivo_eprocesar.php" method="post">
                ...
                <div class="row pt-2">
                    <div class="col-10">
                        <div class="input-group">
                            <select id="sucu" name="sucu1" class="form-control select2 text-center" style="width: 100%;">
            ...
            <div class="lockscreen-credentials">
                <div class="row pt-2">
                    <div class="col-10">
                        <div class="input-group">
                            <select id="esta" name="esta1" class="form-control select2 text-center" style="width: 100%;">
