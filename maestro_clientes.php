    ...
    <div class="col-md-12">
      <div class="card card-saint">
        ...
        <div class="card-header">
          <h3 class="card-title">Maestro de Clientes por Vendedor</h3>
        </div>
        <form class="form-horizontal" action="principal1.php?page=maestro_clientes_ver&mod=1" method="post" id="" name="">
          <div class="card-body">
