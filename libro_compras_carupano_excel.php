...
$resumen1 = mssql_query("SELECT * FROM DBO.VW_ADM_LIBROIVACOMPRAS WHERE  CODSUCU = '00002' and ('$fechai'<=FECHATRAN) AND (FECHATRAN<='$fechaf') ORDER BY (YEAR(FechaCompra)*10000)+(MONTH(FechaCompra)*100)+DAY(FechaCompra),FECHAT ");
