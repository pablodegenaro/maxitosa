			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Disponible Almacen</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="card card-saint">
				<script type="text/javascript">
					function guarda(){
						if (document.getElementById("marca").value != "" && document.getElementById("sucursal").value != "" && document.getElementById("instancia").value != "" && document.getElementById("proveedor").value != "" ){
				...
				<div class="card-header">
					<h3 class="card-title">Disponible en Almacen</h3>
				</div>
				<form class="form-horizontal" action="principal1.php?page=disponible_almacen_ver&mod=1" method="post" id="" name="">
					<div class="card-body">
						<!-- Date -->
