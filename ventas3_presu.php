...
<div class="content-wrapper">ent -->
                ...
                <form id="clie_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="row"> 
                                <div class="col-12">
                                    <h3 class="m-1"><strong>Presupuesto</strong></h3>
                                </div>
                                <div class="col-12 mt-1">
                                    ...
                                    <div class="col-4 pr-3">
                                        <dl class="row">
                                            <dt class="col-sm-8 text-right">Presupuesto Nro. </dt> 
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #084f8a;color: white;">
                        <h4 class="modal-title"><strong>(PRESUPUESTO)</strong> TOTAL OPERACIÓN</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="date" class="form-control" id="fechaemi" name="fechaemi" max="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>" readonly="" required="">
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="ventas3_presu.js"></script>
    <script type="text/javascript" src="ventas3_presu_gestion_tabla.js"></script>