	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">Libro de Ventas MATURIN</h1>
					</div>
				</div>
				<div class="row mb-2">
					...
					<div class="col-sm-3 mt-4 form-check-inline">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<script type="text/javascript">
							function regresa(){
								window.location.href = "principal1.php?page=libro_ventas_maturin&mod=1";
							}
						</script>
		...
		<div class="content">
			...
			<div id="Layer2" style="width:1400px; height:auto;">
				...
				<div align="center">
					<a href="libro_ventas_MATURIN_excel.php?&fechai=<?php echo $fechaii; ?>&fechaf=<?php echo $fechaff; ?>&sucu=<?php echo $sucursal; ?>"><img src="images/excel.jpeg" width="19" height="18" border="0" /> Exportar a Excel</a>
				</div>
				<br>
