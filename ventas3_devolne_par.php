...
<div class="content-wrapper">
                ...
                <form id="clie_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="row"> 
                                <div class="col-12">
                                    <h3 class="m-1" style="color: #fcb813;"><strong>Devolución NE Parcial</strong></h3>
                                </div>
    ...
    <script type="text/javascript" src="ventas3_devolne_par.js"></script>
    <script type="text/javascript" src="ventas3_devolne_par_gestion_tabla.js"></script>