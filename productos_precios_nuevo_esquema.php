    ...
    <div class="content-wrapper" >
        ...
        <section class="content" >            
            <div class="card card-saint">
                ...
                <form name="formulario" method="post" action="productos_precios_procesa_nuevo_esquema.php">
                    <div class="card-body">
                        <?php
                        $productos = mssql_query("SELECT prod.CodProd, Descrip, Marca, prod99.proveedor, Refere, Maneja_Factor, Precio_Manual, Costo_Total, Flete_ME, pvp, sugerido, iva, Profit1, Profit2, Profit3
                            from saprod prod  left join SAPROD_99 prod99 on prod.CodProd = prod99.CodProd inner join SAEXIS as saexis on prod.CodProd=saexis.CodProd  group by  prod.CodProd,saexis.CodProd, prod.Descrip, prod.Marca, prod99.proveedor, prod.Refere, prod99.Maneja_Factor, prod99.Precio_Manual, prod99.Costo_Total, prod99.Flete_ME, prod99.pvp, prod99.sugerido, prod99.iva, prod99.Profit1, prod99.Profit2, prod99.Profit3");
                            ?>
