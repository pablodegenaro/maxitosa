...
if ($_SESSION['login']) {
  ...
  switch (true) {
    ...
    $query = mssql_query("SELECT a.coditem, a.Descrip1, e.clasificacion_categoria, b.proveedor, clas.Descrip InsPadre, clas.Descrip InsPadre,g.ExUnidad/c.CantEmpaq + g.Existen  as cajas_existen,
      ISNULL(SUM((A.Cantidad/CASE WHEN A.EsUnid = 0 THEN 1 ELSE CantEmpaq END)*CASE WHEN a.Tipofac in ('A','C') then 1 else -1 end),0) as CAJAS,
      ...
      <div class="card card-saint">
        <div class="card-header">
          <script type="text/javascript">
            function regresa(){
              window.location.href = "principal1.php?page=rotacion_inv_full&mod=1";
            }
          </script>
          ...
          <table id="example1" class="table table-sm table-bordered table-striped">
            <thead style="background-color: #00137f;color: white;">
              <tr>
                ...
                <th>Inst. Padre</th>
                <th>Proveedor</th>
                <th>Cajas Existencia</th>
                <th>Cajas Rotacion</th>                    
                <th>Monto $</th>
              </tr>
            </thead>
            <tbody>
