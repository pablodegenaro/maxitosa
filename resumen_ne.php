            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Resumen de Notas de Entrega</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="col-md-12">
            <div class="card card-saint">
                ...
                <form class="form-horizontal" action="principal1.php?page=resumen_ne_ver&mod=1" method="post" id="" name="">
                    <div class="card-body">
                        <!-- Date -->
