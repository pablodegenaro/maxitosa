			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Libro de Ventas PZO</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="card card-saint">
				...
				<div class="card-header">
					<h3 class="card-title">Libro Ventas PZO</h3>
				</div>
				<form class="form-horizontal" action="principal.php?page=libro_ventas_pzo_ver&mod=1" method="post" id="" name="">
					<div class="card-body">
						<!-- Date -->
