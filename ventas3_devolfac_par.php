                ...
                <form id="clie_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="row"> 
                                <div class="col-12">
                                    <h3 class="m-1" style="color: #fcb813;"><strong>Devolución Factura Parcial</strong></h3>
                                </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <select id="comentario_delvol" name="comentario_delvol" class="form-control custom-select" style="width: 100%;" required>
                                    ...
                                    <option value="DEVOLUCION POR TRASLADO">DEVOLUCION POR TRASLADO</option>
...
<script type="text/javascript" src="ventas3_devolfac_par.js"></script>
<script type="text/javascript" src="ventas3_devolfac_par_gestion_tabla.js"></script>
<script type="text/javascript" src="ventas3_devolfac_par_gestion_tabla_cxc.js"></script>