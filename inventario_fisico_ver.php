  ...
  if ($existencia == 1) {
   switch (true) {
    ...
    $query = mssql_query("SELECT P.CodProd
     ...
     AND (Substring(C.ORDERBYFIELD,1,LEN('$instancia'+''))='$instancia'+'') 
     ");
        ...
        <div class="card card-saint">
          <div class="card-header">
            <script type="text/javascript">
              function regresa(){
                window.location.href = "principal1.php?page=inventario_fisico&mod=1";
              }
            </script>
            <h3 class="card-title">Inventario Fisico</h3>&nbsp;&nbsp;&nbsp;
