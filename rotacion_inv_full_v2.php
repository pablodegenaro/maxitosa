            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Rotacion de Inventario FULL</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card card-saint">
                <script type="text/javascript">
                    function guarda(){
                        if (document.getElementById("fechai").value != "" && document.getElementById("fechaf").value != "" && document.getElementById("proveedor").value != "" && document.getElementById("sucursal").value != "" ){
                ...
                <form class="form-horizontal" action="principal1.php?page=rotacion_inv_full_v2_ver&mod=1" method="post" id="" name="">
                    <div class="card-body">
                        <!-- Date -->
