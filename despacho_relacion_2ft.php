...
if ($_SESSION['login']) {
	$consultadespacho= mssql_query("SELECT TOP 200 * from appfacturasft  inner join SSUSRS on appfacturasft.usuario = SSUSRS.CodUsua order by correl desc");
	?>
	<script>				
		function elimna_des(correl){
			if(confirm("Esta Seguro de Eliminar este Despacho nro "+ correl)){
				location.href = "principal.php?&page=despachoc_eliminaft&mod=1&id="+correl;
			}
		}
	</script>	
					...
					<div class="col-12">
						<div class="card card-saint">
							<div class="card-header">
								...
								&nbsp;&nbsp;&nbsp;
								<a href="principal.php?page=relacion_despachosft&mod=1"></a>
								&nbsp;&nbsp;&nbsp;
								...
								<div class="card-body">
									<table id="example1" class="table table-sm table-bordered table-striped">
										<tr class="ui-widget-header" style="background-color: #00137f;color: white;">
											...
											<td width="62"><div align="center"><strong>PDF</strong></div></td>
											<td width="46"><div align="center"><strong>Detalle</strong></div></td>
										</tr>
										<?php for($i=0;$i<mssql_num_rows($consultadespacho);$i++){ ?>
											<tr >
												...
												<td>
													<div align="center">
														<div align="center"><?php echo date("d/m/Y", strtotime(mssql_result($consultadespacho,$j,"fechad"))); ?></div>
													</div>
												</td>
												<td>
											...
											<td>
												<div align="center">
													<div align="center">
														...
														$consul_cant_fact = mssql_query("SELECT numeros from appfacturas_detft where correl = '$corr'");
												...
												<td>
													<div align="center">
														<div align="center">
															<!-- EDITAR DESPACHO -->
															<a href="principal1.php?&page=despacho_visualft&mod=1&correl2=<?php echo mssql_result($consultadespacho,$i,"correl"); ?>&usuario=<?php echo  $_SESSION['login']; ?>"> <img src="images/edt.png" width="19" height="18" border="0" />
															</a>
														</div>
													</div>
												</td>
												...
												<td>
													<div align="center">
														<!-- IMPRIMIR DESPACHO -->
														<a href="pdf_despachoft.php?&correl=<?php echo mssql_result($consultadespacho,$i,"correl"); ?>" target="_blank"><img border="0" src="images/imp.gif" width="19" height="18" />
														</a>
													</div>
												</td>
												<td>
													<div align="center">
														...
														<a href="pdf_despacho1ft.php?&correl=<?php echo mssql_result($consultadespacho,$i,"correl"); ?>" target="_blank"><img border="0" src="images/indicadores.png" width="19" height="18" />
														</a>
													</div>
												</td>											
											</tr>
