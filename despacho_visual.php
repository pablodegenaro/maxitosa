...
if ($_SESSION['login']) {
  ...
  $consulta_correl = mssql_query("SELECT * from appfacturas where correl = '$correl'");
...
<script type="text/javascript">
  function elimina(id){
    if(confirm("Esta Seguro que desea eliminar el Documento del Despacho?")){
      location.href="principal1.php?page=despacho_elimina&mod=1&factura="+id;
    }
  }
</script>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          &nbsp;&nbsp;&nbsp;
          <a href="principal1.php?page=despacho_relacion&mod=1"> Relacion de Despachos</a>
          &nbsp;&nbsp;&nbsp;
          ...
          <p><strong>Fecha Des</strong>:  <?php echo $fechai; ?>&nbsp;&nbsp;
            ...
            <a href="principal1.php?page=despacho_edita&mod=1&correl=<?php echo $correl; ?>&usuario=<?php echo $usuario; ?>">&nbsp;&nbsp;&nbsp;<img src="images/edt.png" border="0" width="20" height="18" alt="Editar Despacho" title="Editar Despacho" /></a>
          </p>
        </div>
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
              <?php  
              $numeros =  mssql_query("SELECT numeros, tipofac from appfacturas_det where correl = '$correl'");
              $output = array();
            ...
            <div align="center"><a href="pdf_despacho.php?&correl=<?php echo $correl; ?>" target="_blank"><img border="0" src="images/imp.gif" width="29" height="24" /> Generar Pdf</a>
            </div>
          </div>
        </div>
      </div>
