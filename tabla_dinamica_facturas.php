			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Tabla Dinamica Facturas</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="col-md-12">
			<div class="card card-saint">
				...
				<div class="card-header">
					<h3 class="card-title">Tabla Dinamica de Facturas</h3>
				</div>
				<div class="card-body">
					<!-- Date -->
					<form class="form-horizontal" action="principal.php?page=tabla_dinamica_facturas_ver&mod=1" method="post" id="" name="">
