...
<div class="content-wrapper">
                ...
                <form id="clie_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="row"> 
                                <div class="col-12">
                                    <h3 class="m-1" style="color: #fcb813;"><strong>Devolución Nota de Entrega</strong></h3>
                                </div>
                                <div class="col-12 mt-1">
                                    ...
                                    <div class="col-4 pr-3">
                                        <dl class="row">
                                            <dt class="col-sm-8 text-right">Dev. Nota de Entrega Nro. </dt> 
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #084f8a;color: white;">
                        <h4 class="modal-title"><strong>(DEV. NOTA DE ENTREGA)</strong> TOTAL OPERACIÓN</h4>
    ...
    <script type="text/javascript" src="ventas_devolne.js"></script>
    <script type="text/javascript" src="ventas_devolne_gestion_tabla.js"></script>