  ...
  $.ajax({
    ...
    success: function (data) {
      if (!jQuery.isEmptyObject(data)) {
        ...
        $('.main-sidebar').removeClass('sidebar-dark-primary').removeClass('sidebar-light-primary').addClass(data.colormenu=='dark' ? 'sidebar-dark-primary' : 'sidebar-light-primary');
