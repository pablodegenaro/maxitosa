...
if ($_SESSION['login']) {
  ...
  # ====================
    ...
    $facturas = mssql_query("
      ...
      (select ISNULL(sum(cantidad),0) from saitemfac where saitemfac.numerod = A.numerod and saitemfac.tipofac ='A' and EsUnid = '0') as bultos,
      (select ISNULL(sum(cantidad),0) from saitemfac where saitemfac.numerod = A.numerod and saitemfac.tipofac ='A' and EsUnid = '1') as paquetes,
      ...
      where  A.TipoFac ='A' and A.NumeroR is null  and A.NumeroD not in (SELECT numeros FROM appfacturas_det)  and CodSucu = '$pto_ordaz'

      UNION

      SELECT a.numerod as documento,a.TipoFac as tipodocumento, a.fechae as emision, a.CodClie codigocliente, a.Descrip as razonsocial,c.Descrip AS zona, 
      (select ISNULL(sum(cantidad),0) from saitemfac where saitemfac.numerod = A.numerod and saitemfac.tipofac ='C' and EsUnid = '0') as bultos,
      (select ISNULL(sum(cantidad),0) from saitemfac where saitemfac.numerod = A.numerod and saitemfac.tipofac ='C' and EsUnid = '1') as paquetes,
      MtoTotal/FactorP as totald,a.codvend
      FROM 
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='C' and A.NumeroR is null and A.NumeroD not in (SELECT numeros FROM appfacturas_det) and CodSucu = '$pto_ordaz' ORDER BY A.FechaE ASC");
  ...
  # ================
    ...
    $facturas = mssql_query("
      ...
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='A' and A.NumeroR is null and A.NumeroD not in (SELECT numeros FROM appfacturas_det)  and CodSucu = '$maturin'
      ...
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='C' and A.NumeroR is null  and A.NumeroD not in (SELECT numeros FROM appfacturas_det) and CodSucu = '$maturin' ORDER BY A.FechaE ASC");
  ...
  # ====================
    ...
    $facturas = mssql_query("
      ...
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='A' and A.NumeroR is null  and A.NumeroD not in (SELECT numeros FROM appfacturas_det)  and CodSucu = '$carupano'
      ...
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='C' and A.NumeroR is null and A.NumeroD not in (SELECT numeros FROM appfacturas_det) and CodSucu = '$carupano' ORDER BY A.FechaE ASC");
  ...
  # =============================
    ...
    $facturas = mssql_query("
      ...
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='A' and (A.NumeroR is null or A.NumeroR in (select x.NumeroD from SAFACT as x where cast(x.Monto as int)<cast(A.Monto as int) and X.TipoFac  ='B'
        and x.NumeroD=A.NumeroR)) and A.NumeroD not in (SELECT numeros FROM appfacturas_det) 
      ...
      SAFACT AS A left join SACLIE as B on a.CodClie=b.CodClie 
      left join SAZONA as c on b.CodZona=c.CodZona 
      where  A.TipoFac ='C' and (A.NumeroR is null or A.NumeroR in (select x.NumeroD from SAFACT as x where cast(x.Monto as int)<cast(A.Monto as int) and X.TipoFac  ='D'
        and x.NumeroD=A.NumeroR)) and A.NumeroD not in (SELECT numeros FROM appfacturas_det)  ORDER BY A.FechaE ASC");
  }
            ...
            <div class="card-header">
              <div class="row mb-2">
                <div class="col-sm-6">
                  ...
                  &nbsp;&nbsp;&nbsp;
                  <a href="principal.php?page=despacho_relacion&mod=1">Relacion de Despachos</a>
                  &nbsp;&nbsp;&nbsp;
