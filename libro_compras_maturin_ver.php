  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Libro de Compras MATURIN</h1>
          </div>
        </div>
        <div class="row mb-2">
          ...
          <div class="col-sm-3 mt-4 form-check-inline">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<script type="text/javascript">
              function regresa(){
                window.location.href = "principal1.php?page=libro_compras_maturin&mod=1";
              }
            </script>
    ...
    <div align="center">
      <a href="libro_compras_maturin_excel.php?&fechai=<?php echo $fechaii; ?>&fechaf=<?php echo $fechaff; ?>"><img src="images/excel.jpeg" width="19" height="18" border="0" /> Exportar a Excel</a>
    </div>
    <br>
  </div>
