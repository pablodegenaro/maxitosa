            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Resumen de Cobranzas por Instancias</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card card-saint">
                ...
                <div class="card-header">
                    <h3 class="card-title">Resumen de Cobranzas por Instancias</h3>
                </div>
                <form class="form-horizontal" action="principal1.php?page=cobranza_edv_resumen_ins_ver&mod=1" method="post" id="" name="">
                    <div class="card-body">
                        <!-- Date -->
