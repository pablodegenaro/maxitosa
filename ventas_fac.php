...
<div class="content-wrapper">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <input type="date" class="form-control" id="fechaemi" name="fechaemi" onkeyup="setFechaV('num')" value="<?= date('Y-m-d'); ?>" readonly="" required="">
                                </div>
                            </div>
                        </div>
                        <div class="row form-group">
    ...
    <script type="text/javascript" src="ventas_fac.js"></script>
    <script type="text/javascript" src="ventas_fac_gestion_tabla.js"></script>