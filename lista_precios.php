    ...
    <section class="content">
        <div class="col-md-12">
            <div class="card card-saint">
                ...
                <form class="form-horizontal" action="principal1.php?page=lista_precios_ver&mod=1" method="post" id="" name="">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="form-group row pl-4">
                                ...
                                <div class="custom-control custom-checkbox col-sm-1">
                                    <input class="custom-control-input" type="checkbox" id="iva" value="1.16" name="iva" checked="checked">
                                    <label for="iva" class="custom-control-label">Iva</label>
                                </div>
                                <div class="custom-control custom-checkbox col-sm-2">
                                    <input class="custom-control-input" type="checkbox" id="cubi" value="1" name="cubi">
